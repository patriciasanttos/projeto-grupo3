...
Admin.belongsToMany(Permission, { through: 'admin_permissions', as: 'permissions', foreignKey: 'admin_id' });
Permission.belongsToMany(Admin, { through: 'admin_permissions', as: 'admin', foreignKey: 'permission_id' });
